...
MIGRATION_MODULES = {"sites": "lexmapr_django.contrib.sites.migrations"}
...
STATICFILES_DIRS = [str(APPS_DIR.path("static")), "/app/lexmapr_django/static"]
...
ADMINS = [("""Ivan Sohrab Gill""", "ivan.gill@bccdc.ca")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "lexmapr_django.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "lexmapr_django.users.adapters.SocialAccountAdapter"
